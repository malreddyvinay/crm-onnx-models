...
The easiest way to start creating is by using Power Platform CLI, or PAC. Install PAC and create a folder in your chosen location. I'm going to call it `Miber.CalculateRollup`. The dot is there as namespacing. Run the following command in the terminal.
...
Open the folder in your chosen code editor. I'm using Visual Studio 2022 for development.
...
The **ExecuteDataversePlugin** method is the entrypoint for our plugin. Replace the method with the following: *(I've commented the code to further explain which part does what.)*
...
```
## Build and register the pluginâ
...
|---|---|---|---|---|
| Update | The lookup only | â | â | mb_shift_both | 
| Delete |  | â |  | mb_shift_pre | 
...
For added benefit for you, I've also created a repository in GitHub from which you can download this plugin for your use cases. I'll also make some fixes if needed to this repository. Thanks for reading ðð» and until next time ð!